...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Programa',
            fields=[
                ('pro_codigo', models.CharField(max_length=255, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Electiva',
            fields=[
                ('ele_codigo', models.CharField(max_length=255, primary_key=True, serialize=False)),
