...
Programa.objects.get_or_create(pro_codigo="SIS001", pro_nombre="Ingenieria en Sistemas", fac_codigo=fac2)
Programa.objects.get_or_create(pro_codigo="SIS002", pro_nombre="Ingenieria Automatica", fac_codigo=fac2)
Programa.objects.get_or_create(pro_codigo="SIS003", pro_nombre="Ingenieria Electronica", fac_codigo=fac2)
