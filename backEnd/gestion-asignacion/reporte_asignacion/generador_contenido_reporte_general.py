...
from reporte_asignacion.generador_graficas import generar_grafico_pastel
...
class GenerardorContenidoReporteGeneral:
    ...
    def generar_contenido(self):
        ...
        grafico_pastel = generar_grafico_pastel(conteo_asig_por_programa,ancho=400,alto=300)
