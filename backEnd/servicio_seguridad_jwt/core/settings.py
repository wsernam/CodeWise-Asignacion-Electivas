...
INSTALLED_APPS = [
    ...
    'rest_framework_simplejwt.token_blacklist', # Para el blacklist de tokens
]
# Aquí defines el modelo de usuario personalizado
AUTH_USER_MODEL = "autenticacion.User"
# Configuración para Django REST Framework
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        # Usa las clases de autenticación de simplejwt
...
SIMPLE_JWT = {
    ...
    "SIGNING_KEY": config('JWT_SIGNING_KEY'), # Lee la clave del .env
}
...
DATABASES = {
   'default': {
        ...
        'HOST': config('DB_HOST', default='db_usuarios'),
