...
import { loginAdminService, loginStudentService } from "../services/authService";
...
export const useAuthStore = create<AuthState>((set) => ({
    ...
    loginStudent: async (code: string) => {
        ...
        try {
            ...
            set({ error: "[authStore] Error en el inicio de sesión del estudiante", loading: false });
            throw err;
        }
    },
    ...
    loginAdmin: async (username: string, password: string) => {
        ...
        try {
            ...
            if(!data || !data.token) throw new Error("[authStore] Credenciales inválidas");
            ...
            set({ error: "[authStore] Error en el inicio de sesión del administrador", loading: false });
            throw err;
        }
    },
